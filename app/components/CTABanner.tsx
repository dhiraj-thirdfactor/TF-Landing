...
export default function CTABanner() {
  return (
    <section className="bg-white flex justify-center md:py-20 md:px-6 ">
      {/* Card */}
      <div className="relative w-full max-w-[1160px] min-h-[400px] md:h-[454px]  overflow-hidden bg-[#2563EB] flex flex-col md:flex-row items-start md:items-center  py-[72px] px-[60px]">
        ...
        <div className="relative z-10 w-full max-w-[516px] flex flex-col  gap-[32px] text-center md:text-start items-center md:items-start">
          ...
          <div className="flex flex-col justify-start gap-[16px] md:gap-[24px]">
            <h2 className="md:text-[48px] text-[24px]   text-[#EEEDED] tracking-[-1px]">
            ...
            <p className="text-[#FDFCFBB2] md:max-w-[432px]  text-[14px] md:text-[20px] md:leading-[28px] leading-[130%] font-normal ">Join organizations across Nepal that trust Third Factor to secure and scale their digital interactions.</p>
